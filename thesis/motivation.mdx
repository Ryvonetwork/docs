...
Machine-to-machine commerce creates dense, repeated payment graphs. Agon treats this as a compression problem: keep micropayments off-chain as cumulative channel updates, then settle many channels together when participants cooperate.
