...
Paid routes are priced directly from each upstream provider's public PAYG schedule. The gateway does not add a spread — the price you see is the price the upstream charges for one call, rounded up to the nearest USDC micro when necessary.
