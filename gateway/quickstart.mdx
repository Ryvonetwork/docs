...
<Info>
For every paid route, the advertised price includes the upstream PAYG cost **plus a fixed `$0.0006` gateway settlement surcharge** (to cover the on-chain settlement transaction fee).
</Info>
