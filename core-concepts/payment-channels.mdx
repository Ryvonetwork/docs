...
description: "How Agon models long-lived, directional payment lanes."
---

In Agon, a payment channel is one directional payment relationship from a payer to a payee for a specific token.
