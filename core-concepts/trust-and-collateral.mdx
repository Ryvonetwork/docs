...
description: "How Agon lets different payment relationships pick different safety and efficiency tradeoffs."
---
...
In Agon, trust does **not** mean an operator holds balances in a private database. Balances always live in protocol state.
