...
description: "Settle one channel with one signed `ryvo-cmt-v5` message."
---

Direct settlement is the simplest settlement path.

One payer signs one `ryvo-cmt-v5` message for one channel. The payee submits it with `settle_individual`.
