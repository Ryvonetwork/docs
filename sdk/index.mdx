...
| [Message builders](/sdk/messages) | `agon-cmt-v5` commitment and clearing-round message encoders, plus signing helpers. |
...
<CardGroup cols={2}>
  ...
  <Card title="Messages" icon="signature" href="/sdk/messages">
    Build `agon-cmt-v5` and cooperative-round messages.
  </Card>
